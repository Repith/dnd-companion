  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg bg-green-50">
        <h3 className="mb-2 font-medium text-green-900">Character Summary</h3>
        <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
          <div>
            <span className="text-green-700">Features/Traits:</span>
            <span className="ml-2 font-medium">{featuresTraits.length}</span>
          </div>
          <div>
            <span className="text-green-700">Experience Points:</span>
            <span className="ml-2 font-medium">
              {watch("experiencePoints") || 0}
            </span>
          </div>
          <div>
            <span className="text-green-700">Inspiration:</span>
            <span className="ml-2 font-medium">
              {watch("inspiration") ? "Yes" : "No"}
            </span>
          </div>
          <div>
            <span className="text-green-700">Total Currency:</span>
            <span className="ml-2 font-medium">{totalCurrency} gp</span>
          </div>
        </div>
      </div>
    </div>
